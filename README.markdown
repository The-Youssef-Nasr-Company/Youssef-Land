...
As a result, Flash and Flash Player has already gotten their EOL from Adobe (no support or updates at all). For more information, [click here to learn more about why Flash and Flash Player was killed from no support and updates from Adobe](https://www.adobe.com/products/flashplayer/end-of-life.html).
